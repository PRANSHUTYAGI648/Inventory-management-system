...
def products_page():
    ...
    for index,product in enumerate(products):
        if search and search not in product["name"].lower() and search not in product["category"].lower():
                     continue
    ...
    <a href="/edit_product/{index}">
        <button>Edit</button>
    </a>

    <a href="/delete_product/{index}">
...
def edit_product(index):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return "Please enter valid price and stock."
